...
set "UNPACKED=S:\Vibe Coding Folder\pmide-theia\applications\electron\dist\win-unpacked\PMIDE.exe"
...
if exist "%INSTALLED%" (
  ...
  echo Run PMIDESetup.exe from S:\Vibe Coding Folder\pmide-theia\applications\electron\dist
  pause
)
